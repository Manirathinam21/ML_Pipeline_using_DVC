...
def load_data(data_url: str) -> pd.DataFrame:
    try:
        ...
        print(f"Error: An unexpected error occurred while the loading data.")
        print(e)
        raise
...
def preprocess_data(df: pd.DataFrame) -> pd.DataFrame:
    try:
        ...
        final_df=df.loc[df['sentiment'].isin(['happiness', 'sadness'])]
        ...
        print(f"Error: An unexpected error occurred while preprocessing data.")
        print(e)
        raise
...
def main():
    try:
        data= load_data(data_url='https://raw.githubusercontent.com/entbappy/Branching-tutorial/refs/heads/master/tweet_emotions.csv')
